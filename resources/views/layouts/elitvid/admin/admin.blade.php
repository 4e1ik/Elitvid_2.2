...
<head>
    ...
    <!-- start: Css -->
    <link rel="stylesheet" type="text/css" href="{{asset('/elitvid_assets/admin/css/bootstrap.min.css')}}">

    <!-- plugins -->
    <link rel="stylesheet" type="text/css" href="{{asset('/elitvid_assets/admin/css/plugins/font-awesome.min.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('/elitvid_assets/admin/css/plugins/simple-line-icons.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('/elitvid_assets/admin/css/plugins/animate.min.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('/elitvid_assets/admin/css/plugins/fullcalendar.min.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{asset('/elitvid_assets/admin/css/plugins/dropzone.css')}}"/>
    <link href="{{asset('/elitvid_assets/admin/css/style.css')}}" rel="stylesheet">
    <!-- end: Css -->

    <link rel="shortcut icon" href="{{asset('/elitvid_assets/admin/img/logomi.png')}}">
        ...
        <div class="navbar-header" style="width:100%;">
            ...
            <ul class="nav navbar-nav navbar-right user-nav">
                ...
                <li class="dropdown avatar-dropdown">
                    <img src="{{asset('/elitvid_assets/admin/img/avatar.jpg')}}" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"/>
...
{{--                <input type="text" placeholder="search.."/>--}}
            ...
            <div class="user col-md-12">
                <ul class="nav nav-list">
                    <li class="online">
                        <img src="{{asset('/elitvid_assets/admin/img/avatar.jpg')}}" alt="user name">
                        <div class="name">
                        ...
                        <div class="msg_container_base">
                            <div class="row msg_container send">
                                ...
                                <div class="col-md-3 col-xs-3 avatar">
                                    <img src="{{asset('/elitvid_assets/admin/img/avatar.jpg')}}" class=" img-responsive " alt="user name">
                                </div>
                            </div>
                    ...
                    <ul>
                        <li class="online">
                            <a href=""  data-toggle="tooltip" data-placement="left" title="Akihiko avaron">
                                <div class="user-avatar"><img src="{{asset('/elitvid_assets/admin/img/avatar.jpg')}}" alt="user name"></div>
                                <div class="dot"></div>
                            </a>
                        </li>
                        <li class="offline">
...
<!-- start: Javascript -->
<script src="{{asset('/elitvid_assets/admin/js/jquery.min.js')}}"></script>
<script src="{{asset('/elitvid_assets/admin/js/jquery.ui.min.js')}}"></script>
<script src="{{asset('/elitvid_assets/admin/js/bootstrap.min.js')}}"></script>


<!-- plugins -->
<script src="{{asset('/elitvid_assets/admin/js/plugins/moment.min.js')}}"></script>
<script src="{{asset('/elitvid_assets/admin/js/plugins/fullcalendar.min.js')}}"></script>
<script src="{{asset('/elitvid_assets/admin/js/plugins/jquery.nicescroll.js')}}"></script>
<script src="{{asset('/elitvid_assets/admin/js/plugins/jquery.vmap.min.js')}}"></script>
<script src="{{asset('/elitvid_assets/admin/js/plugins/maps/jquery.vmap.world.js')}}"></script>
<script src="{{asset('/elitvid_assets/admin/js/plugins/jquery.vmap.sampledata.js')}}"></script>
<script src="{{asset('/elitvid_assets/admin/js/plugins/chart.min.js')}}"></script>
<script src="{{asset('/elitvid_assets/admin/js/plugins/moment.min.js')}}"></script>
<script src="{{asset('/elitvid_assets/admin/js/plugins/dropzone.js')}}"></script>
<script src="{{asset('/elitvid_assets/admin/js/plugins/jquery.nicescroll.js')}}"></script>


<!-- custom -->
<script src="{{asset('/elitvid_assets/admin/js/main.js')}}"></script>
<script src="{{asset('/elitvid_assets/admin/js/rowTableProduct.js')}}"></script>

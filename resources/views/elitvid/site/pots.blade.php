        ...
        <section class="prev_direction">
            ...
            <div class="prev_directions__forms">
                <div class="prev_directions__form">
                    <img src="{{asset('/elitvid_assets/imgs/pots/forms/circle_pot.png')}}" alt="">
                ...
                <div class="prev_directions__form">
                    <img src="{{asset('/elitvid_assets/imgs/pots/forms/square_pot.png')}}" alt="">
                    <div class="prev_directions_form--text">
                        <div class="text--description">
                            <h4>Квадратные</h4>
                ...
                <div class="prev_directions__form">
                    <img src="{{asset('/elitvid_assets/imgs/pots/forms/rectangular_pot.png')}}" alt="">
                    <div class="prev_directions_form--text">
                        <div class="text--description">
                            <h4>Прямоугольные</h4>
